...
public class CategoryTabStrip extends HorizontalScrollView {
    ...
    private int highlightTextSizeOffset = 0;
    ...
    private OnCategoryTabStripListener mListener;
    ...
    public CategoryTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        left_edge = getResources().getDrawable(R.color.transparent);
        right_edge = getResources().getDrawable(R.color.transparent);
    }
    ...
    public void setHighlightTextSizeOffset(int highlightTextSizeOffset) {
        this.highlightTextSizeOffset = highlightTextSizeOffset;
    }
    ...
    private void addTab(final int position, String title) {
        ViewGroup tab = (ViewGroup) mLayoutInflater.inflate(R.layout.wg_category_tab, this, false);
        ...
        category_text.setTextColor(textColor != 0 ? textColor : getResources().getColor(R.color.category_tab_text));
    ...
    private void calculateIndicatorRect(Rect rect) {
        ...
        if (textColor != 0) {
            category_text.setTextColor(textColor);
        }
        ...
        if (currentPositionOffset > 0f && currentPosition < tabCount - 1) {
            ...
            if (textColor != 0) {
                next_category_text.setTextColor(textColor);
            }
        ...
        while (i < tabsContainer.getChildCount()) {
            if (i < currentPosition - 1 || i > currentPosition + 1) {
                ...
                if (category_text != null) {
                    ...
                    textDrawable.setTextSize(0, category_text.getTextSize() + highlightTextSizeOffset);
                    textDrawable.setTextColor(highlightTextColor != 0 ? highlightTextColor : getResources().getColor(R.color.theme_color_orange));
    ...
    public interface OnCategoryTabStripListener {
        void onPageSelected(int position);
    }

    public void setOnCategoryTabStripListener(OnCategoryTabStripListener l) {
        mListener = l;
    }
