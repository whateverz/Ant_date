...
public class WgCircle extends AppCompatImageView {
    ...
    private boolean isRound = true;//是否设置为圆

    public WgCircle(Context context) {
        super(context);
        setup();
    }

    public WgCircle(Context context, AttributeSet attrs) {
        super(context, attrs);
        setup();
    }

    public WgCircle(Context context, AttributeSet attrs, int defStyle) {
