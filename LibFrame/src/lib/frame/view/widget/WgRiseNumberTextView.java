...
/**
 * Created by shuaq on 2016/8/30.
 */

public class WgRiseNumberTextView extends AppCompatTextView {
     ...
     * @param context
     */
    public WgRiseNumberTextView(Context context) {
        super(context);
    }
     ...
     * @param attr
     */
    public WgRiseNumberTextView(Context context, AttributeSet attr) {
        super(context, attr);
    }

    public WgRiseNumberTextView(Context context, AttributeSet attr, int defStyle) {
