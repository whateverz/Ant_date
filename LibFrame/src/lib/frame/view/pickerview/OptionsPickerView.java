...
import lib.frame.R;
import lib.frame.view.pickerview.view.BasePickerView;
import lib.frame.view.pickerview.view.WheelOptions;
...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    public TextView getBtnSubmit() {
        return (TextView) btnSubmit;
    }

    public TextView getBtnCancel() {
        return (TextView) btnCancel;
    }
}
