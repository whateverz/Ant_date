package lib.frame.view.pickerview.view;
...
import lib.frame.R;
import lib.frame.view.pickerview.TimePickerView;
...
public class WheelTime {
    public static DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm", Locale.CHINESE);
    private View view;
...
//        wv_year.setLabel(context.getString(R.string.pickerview_year));// 添加文字
        wv_year.setCurrentItem(year - startYear);// 初始化时显
        // 月
...
//        wv_mins.setLabel(context.getString(R.string.pickerview_minutes));// 添加文字
    ...
    public String getTime() {
        return String.valueOf((wv_year.getCurrentItem() + startYear)) + "-" +
