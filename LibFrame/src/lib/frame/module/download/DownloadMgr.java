...
public class DownloadMgr extends AsyncTask<Void, Void, Boolean> {
    ...
    private final Runnable mTaskStarter = new Runnable() {
        ...
        public void run() {
            ...
            try {
                ...
                newTask = download(task, fileName);
    ...
    public DownloadMgr(AppBase context, String dirName,
    ...
    protected AsyncTask<Void, Integer, Long> download(String in, String fileName)
            throws MalformedURLException {
        String out = mFileRoot;
        this.fileName = fileName;
        return new DownloadTask(mAppbase, in, out, fileName, mTaskListener);
    }
